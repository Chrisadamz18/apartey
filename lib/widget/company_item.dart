        ...
        child: Container(
          ...
          child: Column(
            ...
            children : [
              ...
              Text(data["name"], maxLines: 1, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500),),
              const SizedBox(height: 5,),
              Expanded(child: Text(data["type"], style: const TextStyle(fontSize: 12, color: darker),)),
              Visibility(
                visible: selected,
                child: Container(
